...
package com.android.systemui.statusbar.spacewidget;
...
public class SpaceWidget extends FrameLayout {
    ...
    private static final int LAYOUT_SCROLL_BUTTON_THRESHOLD = 3;
    ...
    public SpaceWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void recreateButtonLayout() {
        ...
        for (String button : mButtonNames) {
            ...
            if (pb != null) {
                View buttonView = mInflater.inflate(R.layout.space_widget_button, null, false);
